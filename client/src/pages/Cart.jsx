   ...
   const placeOrder=async ()=>{
         try {
           ...
           if(paymentOption === "COD"){
             ...
             userId: user ._id,items:CartArray.map(item=> ({product: item ._id, quantity: item.
             quantity})),
    ...
    return products.length > 0 && cartItems?(
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <select onChange={e=>updateCartItem(product._id,Number(e.target.value))} value={cartItems[product._id]}className='outline-none'>
                                            {Array(cartItems[products._id]> 9?
                                             cartItems[products._id] :9).fill('').map((_, index) => (
                ...
                <button onClick={()=>{navigate("/products");scrollTo(0,0)}}className="group cursor-pointer flex items-center mt-8
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between">
                        <span>Tax (2%)</span><span>{currency}{getCartAmount()}</span>
                    </p>
